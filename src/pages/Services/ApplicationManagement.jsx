        ...
        <div className="container am-hero">
          <div>
            ...
            <p className="lead reveal" style={{ marginTop: 16, maxWidth: 520 }}>
              End-to-end application management — monitoring, incident response, performance
              optimisation, and controlled releases — so your engineering team ships features, not firefighting plans.
            </p>
