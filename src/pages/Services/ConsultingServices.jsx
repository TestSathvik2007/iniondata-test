        ...
        <div className="container cs-hero">
          <div>
            ...
            <p className="lead reveal" style={{ marginTop: 16, maxWidth: 520 }}>
              Bad architectural decisions compound. We help engineering leaders and founders evaluate
              their options rigorously — so the systems you build today don't become the technical debt
              you're untangling in three years.
            </p>
