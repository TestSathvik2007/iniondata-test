        ...
        <div className="container int-hero">
          <div>
            ...
            <p className="lead reveal" style={{ marginTop: 16, maxWidth: 520 }}>
              We integrate your applications, APIs, and cloud services into a unified ecosystem —
              eliminating data silos, reducing manual handoffs, and enabling real-time automation across your entire stack.
            </p>
