        ...
        <div className="container pm-hero">
          <div>
            ...
            <p className="lead reveal" style={{ marginTop: 16, maxWidth: 520 }}>
              Projects fail from poor coordination, not bad engineering. We manage the entire delivery
              lifecycle — scope, timelines, risks, stakeholders, and communication — so your team
