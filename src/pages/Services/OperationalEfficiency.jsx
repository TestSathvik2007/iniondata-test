        ...
        <div className="container oe-hero">
          <div>
            ...
            <p className="lead reveal" style={{ marginTop: 16, maxWidth: 520 }}>
              Inefficient cloud spend, slow developer workflows, legacy systems, and performance
              regressions silently cap your organisation's ceiling. We find the drag, quantify it, and eliminate it.
            </p>
          ...
          <div className="oe-lottie reveal">
            <lottie-player
              ...
              src="https://assets8.lottiefiles.com/packages/lf20_hy4txm7l.json"
            />
          </div>
        </div>
